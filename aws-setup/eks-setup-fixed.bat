@echo off
REM EKS Setup Script for DeviceStatus Application (Windows) - Fixed Version
...
eksctl create cluster ^
    ...
    --managed ^
    --with-oidc ^
    --tags Environment=Production,Application=DeviceStatus ^
    --timeout 30m

REM Update kubeconfig
echo 🔧 Updating kubeconfig...
%AWS_CLI_PATH% eks update-kubeconfig --region %REGION% --name %CLUSTER_NAME%
...
%AWS_CLI_PATH% iam create-policy ^
...
echo    4. Use kubectl exec for pod debugging
